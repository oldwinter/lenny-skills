...
description: 帮助用户识别长期保留的驱动因素，并实施让客户回头客的行为机制。本指南重点衡量用户的生存曲线，优化高频使用的产品环境。
---

# 掌握保留和参与度

通过将产品嵌入工作流程并创造复合用户价值来实现可持续增长。

利用 11 位嘉宾的见解以及 Lenny 的播客和时事通讯中的帖子，帮助用户提高保留率和参与度。

## 如何提供帮助

1. **定义指标** - 指导用户确定其特定的激活里程碑并设置基于群组的保留跟踪。
2. **审核摩擦** - 分析入职流程和核心用户流程，以消除导致早期退出的技术和心理障碍。
3. **设计习惯** - 建议心理机制，如连续、损失厌恶或增加价值以增加转换成本。
4. **基准绩效** - 将当前的流失率和保留率与行业特定的“良好”和“优秀”标准进行比较，以确定干预措施的优先顺序。
...
优先考虑高用户保留率的基础而不是激进的早期货币化，以确保可持续的长期增长。
...
将首次体验视为保留的最关键点，因为用户很容易在第一次出现摩擦迹象时就放弃产品。
...
有效的保留管理需要跟踪用户群体的长期生存曲线，而不仅仅是高水平的活跃用户数量。
...
使用条纹等机制来营造用户想要保护的进步感，从而提供每天返回的强大动力。
...
承认高流失率对企业规模造成了数学限制，这是任何收购都无法解决的。
...
确保产品在每次使用中都变得更有价值，随着时间的推移，放弃平台的成本会更高。

## 帮助用户的问题

- “用户必须采取什么单一行动才能实现你产品的核心价值？”
- “你的群组保留曲线通常在哪个特定时间点趋于平缓？”
- “在网络或团队建立之前，您的产品是否为单个玩家提供实用性？”
- “如果用户今天停止使用您的产品，他们会失去哪些有价值的数据或进度？”
- “您的每月徽标流失率目前高于还是低于 3% 的临界阈值？”
- “您的保留指标目前是否通过将免费用户与付费用户混合来掩盖免费用户的行为？”

## 标记的常见错误

- **依靠收购来解决客户流失** - 营销无法克服高取消率造成的数学增长上限。
- **使用噪音事件进行活动** - 应用程序打开或屏幕视图等广泛指标会增加活跃用户数量，而无法反映真正的价值交付。
- **忽略非自愿流失** - 未能区分付款失败和产品不满意会导致恢复策略无效。
- **延迟激活工作** - 等待太长时间才能将用户连接到价值，使他们在体验产品的好处之前就放弃了。

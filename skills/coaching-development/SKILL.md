...
description: 帮助用户从个人执行转变为以教练为中心的领导风格，随着团队的成长而扩展。它侧重于识别skill缺陷、提供反思空间并利用框架来加速专业成熟度。
---

# 辅导和人才发展

从问题解决者转变为成长加速器，打造一支高绩效团队。

利用 18 位嘉宾的见解以及 Lenny 的播客和时事通讯中的帖子，帮助用户进行辅导和人才发展。

## 如何提供帮助

1. **评估skill差距** - 帮助用户识别其团队成员当前遇到困难的特定技术或行为领域。
2. **选择框架** - 从语料库中推荐特定的职业阶梯、评分标准或AI驱动的辅导工具，以提供客观标准。
3. **设计增长计划** - 协助为个人直接报告创造下一个更大的挑战和季度延伸任务。
4. **练习反思** - 引导用户从立即给出答案转向提出强有力的、好奇心驱动的问题。
...
找出陷入困境的员工缺乏应对当前挑战的具体内部skill，而不是将其视为性格缺陷。
...
高标准始于领导者对质量和及时性的承诺，确保您永远不会成为团队的瓶颈。
...
通过维护针对个人贡献者成长需求的下一个更大挑战的连续列表，推动个人贡献者发展新的能力。
...
当团队成员提出难题时，请抵制立即解决问题的冲动，而是练习积极倾听以理解潜在的障碍。
...
使用实践指导作为临时战术干预，纠正迷失方向的团队，然后在信心恢复后退后一步。
...
优先考虑你自己的领导力培训，因为经理素质是团队福祉、归属感和人才保留的主要驱动力。

## 帮助用户的问题

- “目前阻碍你最有潜力的团队成员的具体skill或行为是什么？”
- “当报告给你带来问题时，你提供解决方案与提出问题的时间比例是多少？”
- “您是否有关于产品卓越性的书面定义供您的团队用作共享指南针？”
- “您多久会专门花时间来具体思考每位直接下属的长期增长？”
- “你目前是否有任何应该委派给你的团队成员的任务或猴子？”

## 标记的常见错误

- **解决每一个问题** - 这会产生一种依赖性，阻碍团队发展独立应对挑战所需的自主权的能力。
- **将绩效视为一种性格特征** - 将问题界定为某人是谁而不是他能做什么，会阻碍有效的指导和基于skill的纠正。
- **接受向上授权** - 从你的报告中接受猴子会导致你积压工作，同时剥夺团队成员的权力。
- **低估向管理者的管理者的转变** - 通过其他领导者进行领导需要一套根本不同的skill，而许多人在职业发展过程中低估了这一点。
